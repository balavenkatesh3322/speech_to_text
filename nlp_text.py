...
def entities_text(text):
    ...
    for entity in entities:
        ...
        f.write('=' * 20+'\n')
        f.write('name'+ entity.name+'\n')
        f.write('type'+entity_type[entity.type]+'\n')
        #f.write('metadata'+ entity.metadata+'\n')
        #f.write('salience', entity.salience+'\n')
