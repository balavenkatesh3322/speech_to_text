...
def transcribe_file_with_word_time_offsets(speech_file):
    ...
    for result in response.results:
        ...
        for word_info in alternative.words:
            ...
            #print('<span class="pointer" id='+format(start_time.seconds + start_time.nanos * 1e-9)+'>'+word+'</span> ')
            #f.write('<span class="pointer" id='+format(start_time.seconds + start_time.nanos * 1e-9)+'>'+word+'</span> ')
