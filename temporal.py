...
def tag(text):
    ...
    for timex in timex_found:
        ...
        #next_word = text[text.index(timex) + 50]
        print(' ----------Temporal expressions -------> '+timex)
        #print(' ----------show next_word------- '+next_word+' ----------show next_word------- ')
...
def demo():
    import nltk
    text = nltk.corpus.abc.raw('rural.txt')[:1000]
    print(tag(text))
